 ...
 * Post Schema
 * 
 * Defines the blog post document type with all required fields:
 * - title, slug, excerpt, featuredImage, body (Portable Text)
 * - author, category, tags, publishedAt, featured
 * - SEO fields: seoTitle, seoDescription, ogImage
 */
