...
export default function LoginPage() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 w-full max-w-6xl mx-auto min-h-screen lg:min-h-[80vh]">
      <AuthBrandingSection />
      <div className="flex items-center justify-center p-4 sm:p-8 relative">
        ...
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="flex flex-col w-full max-w-md bg-white p-6 sm:p-8 rounded-xl shadow-lg">
          <h1 className="text-slate-900 text-[22px] font-bold pb-3">Find your next 5 customers from social conversations</h1>
          <LoginForm />
        </motion.div>
      </div>
    </div>
